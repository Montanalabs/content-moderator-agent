...
- `content-moderator-agent_safe.eide` — the correct design.
- `content-moderator-agent_unsafe.eide` — the tempting-but-wrong version (the negative example a model must learn to reject).
