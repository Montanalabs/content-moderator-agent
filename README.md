...
- `content-moderator-agent_safe.os` — the correct design.
- `content-moderator-agent_unsafe.os` — the tempting-but-wrong version (the negative example a model must learn to reject).
